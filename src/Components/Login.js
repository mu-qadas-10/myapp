...
const Login = () => {
  ...
  <Link to='/login'><button type="submit" className="btn btn-danger mx-3">login</button></Link>
  <Link to='/register'><button className="btn btn-danger my-3">Register</button></Link>
</form>
    </div>
  )
}
